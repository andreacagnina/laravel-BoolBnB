        ...
        <form id="editPropertyForm" action="{{ route('admin.properties.update', ['property' => $property->slug]) }}"
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="num_beds" id="num_beds" value="{{ old('num_beds', $property->num_beds) }}"
                        class="form-control @error('num_beds') is-invalid @enderror" min="1" max="20" required>
                    @error('num_beds')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="col-md-6">
                    <div class="mb-3 position-relative">
                        ...
                        @error('address')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <div id="suggestions" class="list-group position-absolute w-100 mt-1 shadow-sm"
